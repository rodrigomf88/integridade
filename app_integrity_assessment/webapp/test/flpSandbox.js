		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comvaleintegrityassessmentapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvaleintegrityassessmentapp-display": {
								"semanticObject": "comvaleintegrityassessmentapp",
								"action": "display",
								"description": "Aplicativo para avaliação de integridade de novos candidatos para uma nova oportunidade.",
								"title": "Avaliação de Integridade",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.vale.integrity.assessment.app",
									"url": sap.ui.require.toUrl("com/vale/integrity/assessment/app")
								}
							}
						}
					}
